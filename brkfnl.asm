...
;----->
;initialize position
    shl blockX, 1   ;multiply by 16
    shl blockX, 1 
    shl blockX, 1 
    shl blockX, 1 
    shl blockY, 1   ;multiply by 8
    shl blockY, 1 
    shl blockY, 1 

;--Print first line-->
    mov di, blockX
    shl blockY, 1   ;multiply by 64
    shl blockY, 1 
    shl blockY, 1 
    shl blockY, 1 
    shl blockY, 1 
